  ...
  const formationSteps = [
    {
      ...
      icon: (
        <BsBuildings className="text-primary-color text-5xl group-hover:text-primary-color2" />
      ),
    },
    {
      id: 2,
      step: "EIN",
      icon: (
        <FaFileInvoiceDollar className="text-primary-color text-5xl group-hover:text-primary-color2" />
      ),
    },
    {
      id: 3,
      ...
      icon: (
        <FaRegHandshake className="text-primary-color text-5xl group-hover:text-primary-color2" />
      ),
    },
    {
      id: 4,
      ...
      icon: (
        <CiCreditCard1 className="text-primary-color text-5xl group-hover:text-primary-color2" />
      ),
    },
    {
      id: 5,
      ...
      icon: (
        <BiMessageRoundedDetail className="text-primary-color text-5xl group-hover:text-primary-color2" />
      ),
    },
  ];
  return (
